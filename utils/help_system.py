...
class HelpSystem:
    ...
    def show_detailed_help(self, key: str):
        ...
        with st.expander(f"{tooltip['title']} - Detailed Help"):
    ...
    def get_educational_insights(self, backtest_results: dict) -> list:
        ...
        if total_return > 15:
            ...
            insights.append("Negative returns suggest strategy needs refinement. Try different parameters or timeframes.")
        ...
        if win_rate > 60:
            ...
            insights.append("Moderate accuracy. Focus on cutting losses quickly and letting winners run.")
        else:
